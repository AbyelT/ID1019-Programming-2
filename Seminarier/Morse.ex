defmodule Morse do
  ...
  def decode([?- | rest], {:node, val, left, right}, top) do
    decode(rest, left, top)
  end
  def decode([?. | rest], {:node, val, left, right}, top) do
    decode(rest, right, top)
  end
  def decode([?\s | rest], {:node, val, left, right}, top) do
    [val | decode(rest, top, top)]
  end
